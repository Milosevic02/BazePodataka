            ...
            using (IDbConnection connection = Connection.ConnectionUtil_Basic.GetConnection())
            {
                try
                {
                    ...
                    using (IDbCommand command = connection.CreateCommand())
                    {
                        ...
                        ParameterUtil.AddParameter(command, "returnValue",  DbType.Int32, System.Data.ParameterDirection.ReturnValue);   // Prvi parametar komande obavezno mora biti povratna vrednost
                        ...
                        Console.WriteLine("Broj radnika koji na projektu sa šifrom {0} rade više od {1} sata je: {2}.",
                            spr, brc, result);

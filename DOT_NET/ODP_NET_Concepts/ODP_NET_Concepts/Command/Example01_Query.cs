    ...
    public static class Example01_Query
    {
        public static void Example ()
        {
            ...
            try
            {
                ...
                command.CommandText = "select radnik.mbr, ime, prz prezime, plt, count(spr) br_projekata"
                ...
                while (reader.Read())
                {
                    int mbr = reader.GetInt32(0);           //enumeracija kreće od 0
                    string ime = reader.GetString(1);       //nije moguce čitati vrednosti po imenu kolone sa Get* metodama
